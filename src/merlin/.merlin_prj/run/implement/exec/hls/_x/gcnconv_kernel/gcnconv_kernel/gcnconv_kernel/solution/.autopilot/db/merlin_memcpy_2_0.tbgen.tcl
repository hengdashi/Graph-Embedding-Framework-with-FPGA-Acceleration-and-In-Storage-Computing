set moduleName merlin_memcpy_2_0
set isTopModule 0
...
set C_modelName {merlin_memcpy_2.0}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst int 32 regular {array 108365 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ dst_address0 sc_out sc_lv 17 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "dst", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "108375", "Max" : "108375"}
	, {"Name" : "Interval", "Min" : "108375", "Max" : "108375"}
]}
...
set Spec2ImplPortList { 
	dst { ap_memory {  { dst_address0 mem_address 1 17 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 32 } } }
