...
entity gcnconv_kernel_merlin_memcpy_4_0 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gcnconv_kernel_merlin_memcpy_4_0 is 
    ...
    signal icmp_ln107_reg_186 : STD_LOGIC_VECTOR (0 downto 0);
    signal src_blk_n_R : STD_LOGIC;
    signal ap_enable_reg_pp0_iter8 : STD_LOGIC := '0';
    signal icmp_ln107_reg_186_pp0_iter7_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln107_fu_105_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln107_reg_186_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln107_reg_186_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln107_reg_186_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln107_reg_186_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln107_reg_186_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln107_reg_186_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln107_reg_186_pp0_iter8_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal i_fu_111_p2 : STD_LOGIC_VECTOR (17 downto 0);
    signal i_reg_190 : STD_LOGIC_VECTOR (17 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal add_ln112_fu_134_p2 : STD_LOGIC_VECTOR (58 downto 0);
    signal add_ln112_reg_195 : STD_LOGIC_VECTOR (58 downto 0);
    ...
    signal zext_ln112_2_fu_140_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_1_fu_117_p4 : STD_LOGIC_VECTOR (13 downto 0);
    signal zext_ln112_fu_127_p1 : STD_LOGIC_VECTOR (58 downto 0);
    signal zext_ln112_1_fu_131_p1 : STD_LOGIC_VECTOR (58 downto 0);
    signal trunc_ln112_fu_155_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_2_fu_159_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal empty_fu_167_p1 : STD_LOGIC_VECTOR (511 downto 0);
    signal lshr_ln112_fu_171_p2 : STD_LOGIC_VECTOR (511 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln107_reg_186 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln107_fu_105_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln107_reg_186_pp0_iter7_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                src_addr_read_reg_206 <= m_axi_src_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter8, icmp_ln107_fu_105_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter9)
    begin
        case ap_CS_fsm is
    ...
    add_ln112_fu_134_p2 <= std_logic_vector(unsigned(zext_ln112_fu_127_p1) + unsigned(zext_ln112_1_fu_131_p1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(1);
    ap_CS_fsm_state1 <= ap_CS_fsm(0);
    ap_CS_fsm_state12 <= ap_CS_fsm(2);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_src_RVALID, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter8, icmp_ln107_reg_186_pp0_iter7_reg, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_block_state3_io)) or ((icmp_ln107_reg_186_pp0_iter7_reg = ap_const_lv1_0) and (m_axi_src_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter8 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_src_RVALID, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter8, icmp_ln107_reg_186_pp0_iter7_reg, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_1 = ap_block_state3_io)) or ((icmp_ln107_reg_186_pp0_iter7_reg = ap_const_lv1_0) and (m_axi_src_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter8 = ap_const_logic_1)));
    end process;


    ap_block_state10_pp0_stage0_iter8_assign_proc : process(m_axi_src_RVALID, icmp_ln107_reg_186_pp0_iter7_reg)
    begin
                ap_block_state10_pp0_stage0_iter8 <= ((icmp_ln107_reg_186_pp0_iter7_reg = ap_const_lv1_0) and (m_axi_src_RVALID = ap_const_logic_0));
    end process;

        ap_block_state11_pp0_stage0_iter9 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state2_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_io_assign_proc : process(m_axi_src_ARREADY, icmp_ln107_reg_186)
    begin
                ap_block_state3_io <= ((icmp_ln107_reg_186 = ap_const_lv1_0) and (m_axi_src_ARREADY = ap_const_logic_0));
    end process;
    ...
    ap_condition_pp0_exit_iter0_state2_assign_proc : process(icmp_ln107_fu_105_p2)
    begin
        if ((icmp_ln107_fu_105_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_i_0_phi_fu_97_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln107_reg_186, i_0_reg_93, i_reg_190)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln107_reg_186 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    dst_address0 <= zext_ln107_fu_150_p1(18 - 1 downto 0);
    ...
    dst_d0 <= lshr_ln112_fu_171_p2(32 - 1 downto 0);

    dst_we0_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln107_reg_186_pp0_iter8_reg, ap_enable_reg_pp0_iter9)
    begin
        if (((icmp_ln107_reg_186_pp0_iter8_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter9 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    empty_fu_167_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2_fu_159_p3),512));
    i_fu_111_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_0_phi_fu_97_p4) + unsigned(ap_const_lv18_1));
    icmp_ln107_fu_105_p2 <= "1" when (ap_phi_mux_i_0_phi_fu_97_p4 = ap_const_lv18_34E9A) else "0";
    lshr_ln112_fu_171_p2 <= std_logic_vector(shift_right(unsigned(src_addr_read_reg_206),to_integer(unsigned('0' & empty_fu_167_p1(31-1 downto 0)))));
    m_axi_src_ARADDR <= zext_ln112_2_fu_140_p1;
    ...
    m_axi_src_ARVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln107_reg_186, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln107_reg_186 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_axi_src_RREADY_assign_proc : process(ap_enable_reg_pp0_iter8, icmp_ln107_reg_186_pp0_iter7_reg, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln107_reg_186_pp0_iter7_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter8 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    src_blk_n_AR_assign_proc : process(m_axi_src_ARREADY, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln107_reg_186)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln107_reg_186 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    src_blk_n_R_assign_proc : process(m_axi_src_RVALID, ap_block_pp0_stage0, ap_enable_reg_pp0_iter8, icmp_ln107_reg_186_pp0_iter7_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln107_reg_186_pp0_iter7_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter8 = ap_const_logic_1))) then 
    ...
    tmp_1_fu_117_p4 <= ap_phi_mux_i_0_phi_fu_97_p4(17 downto 4);
    tmp_2_fu_159_p3 <= (trunc_ln112_fu_155_p1 & ap_const_lv5_0);
    trunc_ln112_fu_155_p1 <= i_0_reg_93_pp0_iter8_reg(4 - 1 downto 0);
    zext_ln107_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_93_pp0_iter8_reg),64));
    zext_ln112_1_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(src_offset),59));
    zext_ln112_2_fu_140_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln112_reg_195),64));
    zext_ln112_fu_127_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_117_p4),59));
end behav;
