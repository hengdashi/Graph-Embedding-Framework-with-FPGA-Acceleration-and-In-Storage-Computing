...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name gcnconv_kernel_gcnconv_kernel_ap_fadd_5_full_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name gcnconv_kernel_gcnconv_kernel_ap_fadd_5_full_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips gcnconv_kernel_gcnconv_kernel_ap_fadd_5_full_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files gcnconv_kernel_gcnconv_kernel_ap_fadd_5_full_dsp_32.xci]
generate_target {synthesis simulation} [get_files gcnconv_kernel_gcnconv_kernel_ap_fadd_5_full_dsp_32.xci]
