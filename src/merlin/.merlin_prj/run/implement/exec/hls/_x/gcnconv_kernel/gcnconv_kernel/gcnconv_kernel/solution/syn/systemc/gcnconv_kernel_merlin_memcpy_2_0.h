...
#ifndef _gcnconv_kernel_merlin_memcpy_2_0_HH_
#define _gcnconv_kernel_merlin_memcpy_2_0_HH_
...
struct gcnconv_kernel_merlin_memcpy_2_0 : public sc_module {
    ...
    // Module declarations
    gcnconv_kernel_merlin_memcpy_2_0(sc_module_name name);
    SC_HAS_PROCESS(gcnconv_kernel_merlin_memcpy_2_0);

    ~gcnconv_kernel_merlin_memcpy_2_0();
    ...
    sc_signal< sc_lv<1> > icmp_ln69_reg_184;
    sc_signal< sc_logic > src_blk_n_R;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter8;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter7_reg;
    sc_signal< sc_lv<17> > i_0_reg_91;
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter1_reg;
    ...
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter2_reg;
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter3_reg;
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter4_reg;
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter5_reg;
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter6_reg;
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter7_reg;
    sc_signal< sc_lv<17> > i_0_reg_91_pp0_iter8_reg;
    sc_signal< sc_lv<1> > icmp_ln69_fu_103_p2;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter1_reg;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter2_reg;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter3_reg;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter4_reg;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter5_reg;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter6_reg;
    sc_signal< sc_lv<1> > icmp_ln69_reg_184_pp0_iter8_reg;
    sc_signal< sc_lv<17> > i_fu_109_p2;
    sc_signal< sc_lv<17> > i_reg_188;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<59> > add_ln74_fu_132_p2;
    sc_signal< sc_lv<59> > add_ln74_reg_193;
    sc_signal< sc_lv<512> > src_addr_read_reg_204;
    ...
    sc_signal< sc_lv<17> > ap_phi_mux_i_0_phi_fu_95_p4;
    sc_signal< sc_lv<64> > zext_ln69_fu_148_p1;
    sc_signal< sc_lv<64> > zext_ln74_2_fu_138_p1;
    sc_signal< sc_lv<13> > tmp_5_fu_115_p4;
    sc_signal< sc_lv<59> > zext_ln74_fu_125_p1;
    sc_signal< sc_lv<59> > zext_ln74_1_fu_129_p1;
    sc_signal< sc_lv<4> > trunc_ln74_fu_153_p1;
    sc_signal< sc_lv<9> > tmp_6_fu_157_p3;
    sc_signal< sc_lv<512> > empty_fu_165_p1;
    sc_signal< sc_lv<512> > lshr_ln74_fu_169_p2;
    ...
    void thread_add_ln74_fu_132_p2();
    ...
    void thread_ap_phi_mux_i_0_phi_fu_95_p4();
    ...
    void thread_dst_d0();
    void thread_dst_we0();
    void thread_empty_fu_165_p1();
    void thread_i_fu_109_p2();
    void thread_icmp_ln69_fu_103_p2();
    void thread_lshr_ln74_fu_169_p2();
    ...
    void thread_tmp_5_fu_115_p4();
    void thread_tmp_6_fu_157_p3();
    void thread_trunc_ln74_fu_153_p1();
    void thread_zext_ln69_fu_148_p1();
    void thread_zext_ln74_1_fu_129_p1();
    void thread_zext_ln74_2_fu_138_p1();
    void thread_zext_ln74_fu_125_p1();
