...
set Library     "hls"
set IPName      "gcnconv_kernel"
set Version     "1.0"
set DisplayName "Gcnconv_kernel"
set Revision    "1912120107"
...
set sdx_kernel_name "gcnconv_kernel"
set sdx_kernel_type "hls"
set sdx_kernel_files {/home/centos/CS_259/Project/GCN_FPGA/src/merlin/.merlin_prj/run/implement/exec/hls/__merlinkernel_gcnconv_kernel.cpp}
set enable_xo_gen 1
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/centos/CS_259/Project/GCN_FPGA/src/merlin/.merlin_prj/run/implement/exec/hls/_x/gcnconv_kernel/gcnconv_kernel/gcnconv_kernel/solution"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {gcnconv_kernel_gcnconv_kernel_fadd_32ns_32ns_32_7_full_dsp_1
...
## Variables
set Top "gcnconv_kernel_gcnconv_kernel"
set TopNoPrefix "gcnconv_kernel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 x_data_1 W 0x0 "Data signal of x_data" {{0 32 x_data W 0 "Bit 31 to 0 Data signal of x_data"}}} {0x14 x_data_2 W 0x0 "Data signal of x_data" {{0 32 x_data W 0 "Bit 63 to 32 Data signal of x_data"}}} {0x1c weight_data_1 W 0x0 "Data signal of weight_data" {{0 32 weight_data W 0 "Bit 31 to 0 Data signal of weight_data"}}} {0x20 weight_data_2 W 0x0 "Data signal of weight_data" {{0 32 weight_data W 0 "Bit 63 to 32 Data signal of weight_data"}}} {0x28 edge_index_1 W 0x0 "Data signal of edge_index" {{0 32 edge_index W 0 "Bit 31 to 0 Data signal of edge_index"}}} {0x2c edge_index_2 W 0x0 "Data signal of edge_index" {{0 32 edge_index W 0 "Bit 63 to 32 Data signal of edge_index"}}} {0x34 result_data_1 W 0x0 "Data signal of result_data" {{0 32 result_data W 0 "Bit 31 to 0 Data signal of result_data"}}} {0x38 result_data_2 W 0x0 "Data signal of result_data" {{0 32 result_data W 0 "Bit 63 to 32 Data signal of result_data"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 1118936106 II x}
