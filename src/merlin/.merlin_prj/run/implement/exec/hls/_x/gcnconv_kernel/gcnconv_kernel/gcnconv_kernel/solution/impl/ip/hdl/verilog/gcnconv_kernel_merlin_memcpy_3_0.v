...
module gcnconv_kernel_merlin_memcpy_3_0 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln88_reg_186;
reg    src_blk_n_R;
reg    ap_enable_reg_pp0_iter8;
reg   [0:0] icmp_ln88_reg_186_pp0_iter7_reg;
reg   [17:0] i_0_reg_93;
...
wire   [0:0] icmp_ln88_fu_105_p2;
reg   [0:0] icmp_ln88_reg_186_pp0_iter1_reg;
reg   [0:0] icmp_ln88_reg_186_pp0_iter2_reg;
reg   [0:0] icmp_ln88_reg_186_pp0_iter3_reg;
reg   [0:0] icmp_ln88_reg_186_pp0_iter4_reg;
reg   [0:0] icmp_ln88_reg_186_pp0_iter5_reg;
reg   [0:0] icmp_ln88_reg_186_pp0_iter6_reg;
reg   [0:0] icmp_ln88_reg_186_pp0_iter8_reg;
wire   [17:0] i_fu_111_p2;
reg   [17:0] i_reg_190;
reg    ap_enable_reg_pp0_iter0;
wire   [58:0] add_ln93_fu_134_p2;
reg   [58:0] add_ln93_reg_195;
...
wire   [63:0] zext_ln88_fu_150_p1;
wire   [63:0] zext_ln93_2_fu_140_p1;
wire   [13:0] tmp_3_fu_117_p4;
wire   [58:0] zext_ln93_fu_127_p1;
wire   [58:0] zext_ln93_1_fu_131_p1;
wire   [3:0] trunc_ln93_fu_155_p1;
wire   [8:0] tmp_4_fu_159_p3;
wire   [511:0] empty_fu_167_p1;
wire   [511:0] lshr_ln93_fu_171_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln88_reg_186 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln88_fu_105_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln88_reg_186_pp0_iter7_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        src_addr_read_reg_206 <= m_axi_src_RDATA;
    end
end

always @ (*) begin
    if ((icmp_ln88_fu_105_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln88_reg_186 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln88_reg_186_pp0_iter8_reg == 1'd0) & (ap_enable_reg_pp0_iter9 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        dst_we0 = 1'b1;
    end else begin
        dst_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln88_reg_186_pp0_iter7_reg == 1'd0) & (ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln88_reg_186_pp0_iter7_reg == 1'd0) & (ap_enable_reg_pp0_iter8 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln88_fu_105_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter9 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter8 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter9 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter8 == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln88_fu_105_p2 == 1'd1)))) begin
...
assign add_ln93_fu_134_p2 = (zext_ln93_fu_127_p1 + zext_ln93_1_fu_131_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state3_io)) | ((icmp_ln88_reg_186_pp0_iter7_reg == 1'd0) & (m_axi_src_RVALID == 1'b0) & (ap_enable_reg_pp0_iter8 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state3_io)) | ((icmp_ln88_reg_186_pp0_iter7_reg == 1'd0) & (m_axi_src_RVALID == 1'b0) & (ap_enable_reg_pp0_iter8 == 1'b1)));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter8 = ((icmp_ln88_reg_186_pp0_iter7_reg == 1'd0) & (m_axi_src_RVALID == 1'b0));
end
...
always @ (*) begin
    ap_block_state3_io = ((icmp_ln88_reg_186 == 1'd0) & (m_axi_src_ARREADY == 1'b0));
end
...
assign dst_address0 = zext_ln88_fu_150_p1;

assign dst_d0 = lshr_ln93_fu_171_p2[31:0];

assign empty_fu_167_p1 = tmp_4_fu_159_p3;

assign i_fu_111_p2 = (ap_phi_mux_i_0_phi_fu_97_p4 + 18'd1);

assign icmp_ln88_fu_105_p2 = ((ap_phi_mux_i_0_phi_fu_97_p4 == 18'd216730) ? 1'b1 : 1'b0);

assign lshr_ln93_fu_171_p2 = src_addr_read_reg_206 >> empty_fu_167_p1;

assign m_axi_src_ARADDR = zext_ln93_2_fu_140_p1;
...
assign tmp_3_fu_117_p4 = {{ap_phi_mux_i_0_phi_fu_97_p4[17:4]}};

assign tmp_4_fu_159_p3 = {{trunc_ln93_fu_155_p1}, {5'd0}};

assign trunc_ln93_fu_155_p1 = i_0_reg_93_pp0_iter8_reg[3:0];

assign zext_ln88_fu_150_p1 = i_0_reg_93_pp0_iter8_reg;

assign zext_ln93_1_fu_131_p1 = src_offset;

assign zext_ln93_2_fu_140_p1 = add_ln93_reg_195;

assign zext_ln93_fu_127_p1 = tmp_3_fu_117_p4;

endmodule //gcnconv_kernel_merlin_memcpy_3_0
