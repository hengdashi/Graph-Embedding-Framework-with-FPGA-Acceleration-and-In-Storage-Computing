...
_ssdm_SpecFuncInstantiation(dst_idx_0,dst_idx_1,src_idx_0, "");
 unsigned long i;
...
_ssdm_op_SpecLoopTripCount(0, 128082, 64041, "");
...
_ssdm_SpecFuncInstantiation(dst_idx_0,src_idx_0,src_idx_1, "");
 unsigned long i;
...
_ssdm_SpecFuncInstantiation(dst_idx_0,src_idx_0, "");
 unsigned long i;
...
_ssdm_op_SpecLoopTripCount(0, 108365, 54182, "");
...
_ssdm_op_SpecLoopTripCount(0, 216730, 108365, "");
 dst[total_offset1 + i] = src[total_offset2 + i];
  }
}
...
_ssdm_op_SpecInterface(edge_index, "m_axi", 0, 0, "", 0, 216730, "gmem", "slave", "", 16, 16, 16, 16, "", "");

_ssdm_op_SpecInterface(result, "m_axi", 0, 0, "", 0, 19717, "gmem", "slave", "", 16, 16, 16, 16, "", "");

_ssdm_op_SpecInterface(weight, "m_axi", 0, 0, "", 0, 500, "gmem", "slave", "", 16, 16, 16, 16, "", "");

_ssdm_op_SpecInterface(x, "m_axi", 0, 0, "", 0, 616157, "gmem", "slave", "", 16, 16, 16, 16, "", "");

_ssdm_op_SpecInterface(edge_index, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");

_ssdm_op_SpecInterface(result, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");

_ssdm_op_SpecInterface(weight, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");

_ssdm_op_SpecInterface(x, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");

_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");

_ssdm_DataPack( result, 0, 0, "", "", "");

_ssdm_DataPack( weight, 0, 0, "", "", "");

_ssdm_DataPack( x, 0, 0, "", "", "");
 float weight_buf_0[500][16];

_ssdm_SpecArrayPartition( weight_buf_0, 2, "CYCLIC", 8, "");
...
_ssdm_SpecArrayPartition( x_mul, 2, "COMPLETE", 0, "");
 float deg[19717];
...
_ssdm_SpecArrayPartition( x_buf_0, 1, "CYCLIC", 8, "");
