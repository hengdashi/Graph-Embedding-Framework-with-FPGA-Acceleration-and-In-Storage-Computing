...
{
  float weight_buf_0[8000];
  int edge_index_buf_3[216730];
  int edge_index_buf_2[128082];
...
#pragma ACCEL interface variable=x max_depth=9858500 depth=9858500
  ...
  memcpy((void *)(&weight_buf_0[0]),(const void *)(&weight[0]),sizeof(float ) * 8000);
...
#pragma ACCEL PIPELINE AUTO
        mul += x_buf_0[k] * weight_buf_0[k * 16 + j];
      }
      x_mul[i][j] = mul;
    }
  }
  memcpy((void *)(&edge_index_buf_2[0]),(const void *)(&edge_index[88648]),sizeof(int ) * 128082);
// #pragma ACCEL pipeline
  assign_index_i:
  for (int i = 0; i < 19717; ++i) {
...
#pragma ACCEL PARALLEL COMPLETE
      edge_index_buf_2[j * 108365 + i] = i;
    }
  }
  memcpy((void *)(&edge_index[88648]),(const void *)(&edge_index_buf_2[0]),sizeof(int ) * 128082);
// #pragma ACCEL pipeline
  assign_weight:
